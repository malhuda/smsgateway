...
class Wilayah_model extends CI_Model {
	...
	function get($criteria=null,$limit=null,$offset=1){
		$data = array();
         ...
         $pengguna->NO_PROP;
         $pengguna->NO_KAB; }
		 $this->db->select("*")->from("ASSET_USER")->join('SETUP_PROP', 'ASSET_USER.NO_PROP = SETUP_PROP.NO_PROP','left')->where("ASSET_USER.NO_PROP",$pengguna->NO_PROP)->where("ASSET_USER.NO_KAB",$pengguna->NO_KAB);
