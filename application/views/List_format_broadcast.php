...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('.keluargaShow').bind('click', function(e) {
                    ...
                    $.Zebra_Dialog('', {
                        source: {'iframe': {
                                'src': '<?php echo site_url($this->router->fetch_directory() . 'format_broadcast/index') ?>' + '/' + $(this).attr("id"),
                                'height': 350,
                                'type': 'question'
                            }},
                        width: 1050,
                ...
                $('.menu_button').bind('click', function(e) {
                    window.location = "<?php echo site_url($this->router->fetch_directory() . 'format_broadcast/index') ?>";
                });
  ...
  <body> <script>
        ...
        <script>
 function delete_format_broadcastitems_by_id(ID)
    {
      if(confirm('Anda yakin akan menghapus data ini?'))
      {
          $.ajax({
            url : "<?php echo site_url('format_broadcast/ajax_delete')?>/"+ID,
            type: "POST",
            dataType: "JSON",
          ...
          <div class="col-md-12"><?php echo $this->session->flashdata('message'); ?>
                        <div class="panel panel-default" id="toolbar-showcase">
                           <div class="panel-heading"><div class="btn btn-default"><i class="glyphicon glyphicon-download"></i>   <strong>    
                            <a class="btn btn-default"  href="<?php echo base_url('format_broadcast'); ?>"></i> Format Broadcast</a>      
                            </strong></div>
                            <div class="panel-toolbar-wrapper pl10 pr10 pt5 pb5">
                                <div class="panel-toolbar hide" id="toolbar-toshow">
                                     <div class="col-md-12">
                                         ...
                                         <button id="submitclose" type="submit" disabled="disabled" formaction="<?php echo base_url(); ?>format_broadcast/multiple_proses" class="btn btn-teal" data-toggle="tooltip" data-placement="top" title="Hapus Hanya Yang Dicentang"><strong>Hapus <i class="glyphicon glyphicon-trash"></i></strong>
                                           </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Proses Semua Data :</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url(); ?>format_broadcast/hapus_semua" class="btn btn-teal"  data-toggle="tooltip" data-placement="right" title="Hapus Semua Data"  onClick="return confirm('Apakah anda yakin akan menghapus semua data ?');"><strong>Kosongkan Table<i class="glyphicon glyphicon-trash"></i></strong>
                                           </a></font> 
                                       </div>
                                       <script type="text/javascript">    
                           ...
                           <div class="table-responsive panel-collapse pull out">  <p align="right"><a class="btn btn-primary" href="<?php echo base_url(); ?>format_broadcast"><i class="ico-users"></i><strong>
                                ADD FORMAT</strong></a></p>
                 ...
                 <td colspan="1" align="center" ><strong>FORMAT PERTAMA</td></strong>
                 <td colspan="1" align="center" ><strong>FORMAT KEDUA</td></strong>
                <td colspan="1" align="center" ><strong>TAMPILAN</td></strong>
                        ...
                        'value'       => $data["id"]
                         ...
                         <label for="customcheckbox-two2<?php echo ($page+$i+1); ?>"></label>   
                                            ...
                                            <td colspan="1" align="center" ><?php echo ($page+$i++); ?>.</td>
                                             <td style="text-align:center"><?php echo $data["keyword1"] ?></td>
                                             <td style="text-align:center"><?php echo $data["keyword2"] ?></td>
                                             <td style="text-align:center"><?php echo $data["result"] ?></td>
                                             <td style="text-align:left"><p align="center"> <a class="btn btn-success" href="<?php echo base_url(); ?>format_broadcast/edit/<?php echo $data["id"]; ?>" data-toggle="tooltip" data-placement="left" title="Edit Data ?" ><span class="icon"></span> <i class="ico-pencil"></i></a>
                                             <a class="btn btn-danger" href="javascript:void()" onclick="delete_format_broadcastitems_by_id('<?php echo $data["id"]; ?>')" data-toggle="tooltip" data-placement="bottom" title="Hapus Data ?" ><span class="icon"></span> <i class="ico-trash"></i></a></p></td>
                                            </tr>
                                             <?php
                                                }
                                                ?>
                                      ...
                                      <tfoot> 
                                        <tr height="0"><td></td><td></td><td></td><td></td><td align="center" class="paging"><?php echo $this->pagination->create_links(); ?></td>                                         
