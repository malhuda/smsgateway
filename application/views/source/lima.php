...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <script type="text/javascript">
    ...
    <form  id="frmDaftar" method="post" action="<?php echo site_url();  ?>load_ajax/limabelaskosongsatu" enctype="multipart/form-data">
  ...
  <?= $this->widget_wilayah->get_kabupaten(array('name' => 'tabel[NO_KAB]', 'data_awal' => array('NO_PROP' => $NO_PROP, 'NO_KAB' => $NO_KAB), 'param' => '')) ?>
              ...
              <div class="form-group">
               <label class="control-label col-md-4" for="PERIODE" >PERIODE</label>
                    <div class="col-md-8">
                      <select name="PERIODE" class="form-control info disableButton" >
        ...
        <div class="form-group">
                <div class="col-md-6">
                  <button type="submit" class="btn btn-default" />
                    <strong>TAMPILKAN</strong> <i class='icon ico-search'></i></button>
              </div>
       </div>
   </div>
     </div>
                  ...
                  <tr class="gradeA">
                    ...
                    <div class="checkbox custom-checkbox nm">
                     ...
                     <td><?php echo $offset; ?>.</td>                                            
                             ...
                             <td><?php  echo '<p align="center"><a class="btn btn-default" href="javascript:void()" data-toggle="tooltip" data-placement="bottom" title="Ubah Data ?" onclick="edit_person('."'".$data["NIK"]."'".')">UBAH <i class="glyphicon glyphicon-plus"></i></a></p>'; ?></td>
                                <td> <?php if(empty($data["QUERY_U"])){ ?><?php echo $data["QUERY_U"] ?>
                                  <?php }else{ ?>
                        ...
                        <form id="form" class="panel panel-default form-horizontal form-bordered" name="validation" action="#" method="POST">
                            ...
                            <div class="panel-body pt0">
                               ...
                               <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-4">TGL LHR </label>
                                    <div class="col-sm-8">
                                     <input name="TGL_LHR"  value="<?php echo set_value('TGL_LHR'); ?>" placeholder="DD/MM/YYYY" class="form-control datepicker" type="text">
                                     <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
