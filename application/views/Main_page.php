                                    ...
                                    <div class="col-xs-10 panel">
                                        <div class="panel-body text-center">
                                            <h4 class="semibold nm"><?php
                                                ...
                                                ?>
                                                <?php
                                                if ($pengguna->LEVEL_LOGIN  == 1) {
                                                    echo "Administrator";
                                                } elseif ($pengguna->LEVEL_LOGIN == 2) {
                                                    echo "Operator";
                                                }
                                                ?></h4>
                                ...
                                <div class="panel-body">
                                    <div class="panel-body">
                                        <p>NOMOR SMS GATEWAY <font color="red">081210997334</font></p>
                                                 ...
                                                 Selamat datang <strong>"<?php echo $pengguna->NAMA; ?>" </strong>,silahkan gunakan aplikasi ini sesuai kebutuhan pekerjaan anda .</br>
                                                 Untuk keluar silahkan pilih menu logout ,lalu ok.   </br>
                            ...
                            <div class="col-md-12">
                                ...
                                <script>
                                     $(document).ready(function(){
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: '<?php echo base_url() ?>program/aktifkan_gammu',
                                            data: {aktifkan:aktifkan},
                                            success:function(data)
                                            {
                                                alert('SERVICE GAMMU BERHASIL DIAKTIFKAN');
                                                var url = '<?php echo base_url() ?>program/load_page';  
                                ...
                                <script>
                                     $(document).ready(function(){
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: '<?php echo base_url() ?>program/stop_gammu',
                                 ...
                                 <script>
                                     $(document).ready(function(){
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: '<?php echo base_url() ?>program/cek_pulsa_modemnya',
                                        ...
                                        if($status == 1)
                                        {
                                         echo '<span class="text-primary semibold"> Connection Success</span>
                                            ...
                                            <input id="hentikan" type="submit" name="hentikan" class="btn btn-danger" name="submit" value="STOP SERVICE GAMMU">
                                            </form>
                                        </span></br>
                                        <!-- <form id="cekpulsa" method="post" action='.base_url().'program/cek_pulsa_modemnya>
                                             <input id="pulsa" type="submit" name="pulsa" class="btn btn-primary" name="submit" value="CEK PULSA">
                                            </form>-->
                                        ';
                                         ?> 
                                         ...
                                         <?php 
                                            ...
                                            elseif($status == 0){
                                                 ...
                                                 <input id="aktifkan" type="submit" name="aktifkan" class="btn btn-success" name="submit" value="START SERVICE GAMMU">
                                                 </form>
                                             </span>
                                             </br>
                                         <!--<form id="cekpulsa" method="post" action='.base_url().'program/cek_pulsa_modemnya>
