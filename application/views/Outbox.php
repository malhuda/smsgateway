...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('.keluargaShow').bind('click', function(e) {
                    ...
                    $.Zebra_Dialog('', {
                        source: {'iframe': {
                                'src': '<?php echo site_url($this->router->fetch_directory() . 'outbox/index') ?>' + '/' + $(this).attr("id"),
                                'height': 350,
                                'type': 'question'
                            }},
                        width: 1050,
                ...
                $('.menu_button').bind('click', function(e) {
                    window.location = "<?php echo site_url($this->router->fetch_directory() . 'outbox/index') ?>";
                });
  ...
  <body> <script>
        ...
        <script>
 function delete_outbox_by_id(ID)
    {
      if(confirm('Anda yakin akan menghapus data ini?'))
      {
          $.ajax({
            url : "<?php echo site_url('outbox/ajax_delete')?>/"+ID,
            type: "POST",
            dataType: "JSON",
     ...
     <form action="<?php echo site_url($this->router->fetch_directory() . $this->router->fetch_class() . '/index') ?>" method="post" enctype="multipart/form-data" >
          <div class="col-md-12"><?php echo $this->session->flashdata('message'); ?>
                        <div class="panel panel-default" id="toolbar-showcase">
                           <div class="panel-heading"><div class="btn btn-default"><i class="ico-upload2"></i>   <strong>    
                            <a class="btn btn-default"  href="<?php echo base_url('outbox'); ?>"></i> Outbox Messages</a>      
                            </strong></div>
                                ...
                                <div class="panel-toolbar hide" id="toolbar-toshow">
                                     <div class="col-md-12">
                                        ...
                                        <font id="excel" class="drop-down-show-hide">                             
                                         <button type="submit" formaction="<?php echo base_url(); ?>outbox/multiple_proses" class="btn btn-teal"  target="_blank" data-toggle="tooltip" data-placement="top" title="Export Hanya Yang Dicentang"><strong>Generate To Excel <i class="glyphicon glyphicon-refresh"></i></strong>
                                           </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Proses Semua Data :</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url(); ?>outbox/all_to_excel" class="btn btn-teal"  target="_blank" data-toggle="tooltip" data-placement="right" title="Export Semua Data"><strong>Generate All To Excel <i class="glyphicon glyphicon-refresh"></i></strong>
                                           </a></font>  
                                         <font id="csv" class="drop-down-show-hide">                             
                                         <button type="submit" formaction="<?php echo base_url(); ?>outbox/multiple_proses" class="btn btn-teal"  target="_blank" data-toggle="tooltip" data-placement="top" title="Export Hanya Yang Dicentang"><strong>Generate To Csv <i class="glyphicon glyphicon-refresh"></i></strong>
                                           </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Proses Semua Data :</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url(); ?>outbox/all_to_csv" class="btn btn-teal"  target="_blank" data-toggle="tooltip" data-placement="right" title="Export Semua Data"><strong>Generate All To Csv <i class="glyphicon glyphicon-refresh"></i></strong>
                                           </a></font> 
                                         <font id="pdf" class="drop-down-show-hide">                            
                                         <button type="submit" formaction="<?php echo base_url(); ?>outbox/multiple_proses" class="btn btn-teal"  target="_blank" data-toggle="tooltip" data-placement="top" title="Export Hanya Yang Dicentang"><strong>Generate To Pdf <i class="glyphicon glyphicon-refresh"></i></strong>
                                           </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Proses Semua Data :</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url(); ?>outbox/all_to_pdf" class="btn btn-teal"  target="_blank" data-toggle="tooltip" data-placement="right" title="Export Semua Data"><strong>Generate All To Pdf <i class="glyphicon glyphicon-refresh"></i></strong>
                                           </a></font> 
                                          <font id="hapus" class="drop-down-show-hide">               
                                         <button id="submitclose" type="submit" disabled="disabled" formaction="<?php echo base_url(); ?>outbox/multiple_proses" class="btn btn-teal" data-toggle="tooltip" data-placement="top" title="Hapus Hanya Yang Dicentang"><strong>Hapus <i class="glyphicon glyphicon-trash"></i></strong>
                                           </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Proses Semua Data :</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url(); ?>outbox/hapus_semua" class="btn btn-teal"  data-toggle="tooltip" data-placement="right" title="Hapus Semua Data"  onClick="return confirm('Apakah anda yakin akan menghapus semua data ?');"><strong>Kosongkan Table<i class="glyphicon glyphicon-trash"></i></strong>
                                           </a></font> 
                                       </div>
                                       <script type="text/javascript">    
                 ...
                 <td colspan="1" align="left" ><strong>PENERIMA</td></strong>
                 <td colspan="1" align="left" ><strong>NOMOR TUJUAN</td></strong>
                        ...
                        'value'       => $data["ID"]
                         ...
                         <label for="customcheckbox-two2<?php echo ($page+$i+1); ?>"></label>   
                                            ...
                                            <td colspan="1" align="center" ><?php echo ($page+$i++); ?>.</td>
                                             <td style="text-align:left"><?php echo $data["SendingDateTime"] ?></td>
                                             <td style="text-align:left"><?php echo $data["DestinationNumber"] ?></td>
                                             <td style="text-align:left"><?php echo $data["TextDecoded"] ?></td>
                                             <td style="text-align:left"><p align="center"> <?php  echo '<a class="btn btn-info" href="javascript:void()" data-toggle="tooltip" data-placement="bottom" title="Lihat Detail Pesan ?"  onclick="detail_outbox('."'".$data["ID"]."'".')"> <i class="glyphicon glyphicon-edit"></i></a>
                                             &nbsp;&nbsp;&nbsp;'; ?>&nbsp;&nbsp;
                                             <a class="btn btn-danger" href="javascript:void()" onclick="delete_outbox_by_id('<?php echo $data["ID"]; ?>')" data-toggle="tooltip" data-placement="bottom" title="Hapus Data ?" ><span class="icon"></span><i class="ico-trash"></i></a></p></td>
                                            </tr>
                                             <?php
                                                }
                                                ?>
                                      ...
                                      <tfoot> 
                                        <tr height="0"><td></td><td></td><td></td><td></td>
        ...
        <script src="<?php echo base_url('assets/datatables/js/dataTables.bootstrap.js')?>"></script>
            <script src="<?php echo base_url('assets/bootstrap-datepicker/js/bootstrap-datepicker.min.js')?>"></script>
                ...
                function detail_outbox(ID)
              {
                  ...
                  $('.help-block').empty(); 
                  $.ajax({
                      url : "<?php echo site_url('outbox/detail')?>/" + ID,
                      type: "GET",
                     dataType: "JSON",
                      success: function(data)
                      {
                          ...
                          $('[name="SendingDateTime"]').val(data.SendingDateTime);
                           $('[name="SendBefore"]').val(data.SendBefore);
                          ...
                          $('[name="TextDecoded"]').val(data.TextDecoded);
                           $('[name="ID"]').val(data.ID);
                           $('[name="MultiPart"]').val(data.MultiPart);
                           $('[name="RelativeValidity"]').val(data.RelativeValidity);
                           $('[name="SenderID"]').val(data.SenderID);
                           $('[name="SendingTimeOut"]').val(data.SendingTimeOut);
                           $('[name="DeliveryReport"]').val(data.DeliveryReport);
                           $('[name="CreatorID"]').val(data.CreatorID);
                          $('#modal_form').modal('show'); 
                          $('.modal-title').text('DETAIL OUTBOX');
                      },
                      error: function (jqXHR, textStatus, errorThrown)
                      {
              ...
              function replay_outbox(ID)
{
    ...
    if(save_method == 'replay') {
        url = "<?php echo site_url('outbox/replay')?>/" + <?php echo $data["ID"]; ?>;
    } else {
        url = "<?php echo site_url('outbox/replay')?>/" + <?php echo $data["ID"]; ?>;
    }
                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content" >
                      <div class="modal-header btn-teal">
                        ...
                        <h4 ><p align="center"><strong>DETAIL PESAN OUTBOX <i class="glyphicon glyphicon-user"></i></strong></p></h4>
                      </div>   
                         <div>
                         <div class="col-md-12">
                            ...
                            <div class="panel-body pt0">
                             ...
                             <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-4">SendBefore</label>
                                    <div class="col-sm-8">
                                        <input name="SendBefore" type="text" class="form-control" value="<?php echo $data["SendBefore"]; ?>" >
                                      <span class="help-block"></span></div>
                                </div><div class="form-group">
                                    <label class="control-label col-sm-4">SendAfter</label>
                                    <div class="col-sm-8">
                                        <input name="SendAfter" type="text" class="form-control" value="<?php echo $data["SendAfter"]; ?>" >
                                      <span class="help-block"></span></div>
                                </div><div class="form-group">
                                    ...
                                    <label class="control-label col-sm-4">Multipart</label>
                                    <div class="col-sm-8">
                                        <input name="MultiPart" type="text" class="form-control" value="<?php echo $data["MultiPart"]; ?>" >
                                      <span class="help-block"></span></div>
                                </div>
                             </div> <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-4">SendingTimeOut</label>
                                    <div class="col-sm-8">
                                        <input name="SendingTimeOut" type="text" class="form-control" value="<?php echo $data["SendingTimeOut"]; ?>" >
                                      <span class="help-block"></span></div>
                             </div> <div class="form-group">
                                    <label class="control-label col-sm-4">DeliveryReport</label>
                                    <div class="col-sm-8">
                                        <input name="DeliveryReport" type="text" class="form-control" value="<?php echo $data["DeliveryReport"]; ?>" >
                                      <span class="help-block"></span></div>
                             </div>   <div class="form-group">
