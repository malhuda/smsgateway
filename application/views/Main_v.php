                    ...
                    <li class="dropdown custom" id="header-dd-notification">
                        ...
                        <div class="dropdown-menu" role="menu">
                            <div class="dropdown-header">
                                ...
                                <span class="option text-right"><a href="<?php echo base_url(); ?>inbox">Lihat Semua Inbox</a></span>
                            </div>
                    ...
                    <script type="text/javascript">
                      function Ajax()
                      {
                          ...
                          if ($http) {
                              ...
                              $http.open('GET', '<?php echo base_url("program/load"); ?>' + '?' + new Date().getTime(), true);
                              $http.send(null);
                          }
                          else  {
                              document.getElementById('respons').innerHTML = $http.responseText;
                    ...
                    <li class="dropdown profile">
                        <a href="javascript:void(0);" class="dropdown-toggle dropdown-hover" data-toggle="dropdown">
                            <span class="meta">
                                ...
                                <span class="avatar"><img src="<?php echo base_url(); ?>assets/foto/<?php echo $pengguna->FOTO; ?>" class="img-circle" alt="" onError="this.onerror=null;this.src='<?php echo base_url(); ?>assets/foto/no-photo.jpg' ;" class="img-circle" /></span>
                                <span class="text hidden-xs hidden-sm pl5"><strong><font color="white"><?php echo $pengguna->NAMA; ?></font></strong></span>
                            </span>
                        </a>
            ...
            <section class="content slimscroll">
                ...
                <ul class="topmenu topmenu-responsive" data-toggle="menu">
                  ...
                  <!--  <li>
                   ...
                   <li>
                        <a href="<?php echo base_url("sms_broadcast"); ?>" target="_blank" onClick="return confirm('Anda akan mengirim pesan ke semua kontak adb ?');" data-target="#dashboard" data-toggle="submenu" data-parent=".topmenu">
                            <span class="figure"><i class="ico-user"></i></span>
                            <span class="text">SMS BROADCAST</span>
                        </a>
                    </li>
                    <li>
                        ...
                        <a href="<?php echo base_url("webmaster"); ?>" data-target="#dashboard" data-toggle="submenu" data-parent=".topmenu">
                            <span class="figure"><i class="ico-user22"></i></span>
                            <span class="text">USER</span>
                        </a>
                    </li> 
                     <li>
                        <a href="<?php echo base_url("login/logout"); ?>"  onClick="return confirm('Apakah anda ingin keluar dari aplikasi ?');" data-target="#dashboard" data-toggle="submenu" data-parent=".topmenu">
        ...
        <section id="main" role="main">
            ...
            <!--  Mulai load halaman dinamis dan set interval waktu ajax untuk notifikasi sms baru dan jalankan perintah auto replay berdasarkan nomor dan keyword sms -->
                 <?php $this->load->view($main);?>
                  ...
                  <script>
                  $(document).ready(function() {
                  $("#responsecontainer").load("<?php echo base_url(); ?>auto_replay_broadcast/proses_auto_replay");
                  var refreshId = setInterval(function()
                  {
                  $("#responsecontainer").load('<?php echo base_url(); ?>auto_replay_broadcast/proses_auto_replay');
                  }, 1000);
